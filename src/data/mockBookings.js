...
export const saveNewBooking = (bookingData) => {
  ...
  const formattedBooking = {
    ...
    car: `${bookingData.carBrand || ''} ${bookingData.carModel || ''} (${bookingData.carNumber || 'નંબર આપ્યો નથી'})`.trim(),
    fuelType: bookingData.fuelType || "પેટ્રોલ/CNG",
    service: bookingData.serviceName || "જનરલ કાર સર્વિસ",
    date: bookingData.date || "આજની તારીખ",
    time: bookingData.time || "સવારે ૧૦:૦૦",
    problemNote: bookingData.problemNote || "કોઈ સ્પેશિયલ નોટ નથી",
    status: "pending",
